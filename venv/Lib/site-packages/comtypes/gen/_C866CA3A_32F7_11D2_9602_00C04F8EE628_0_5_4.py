...
__all__ = [
    'SPGS_DISABLED', 'DISPID_SRCBookmark', 'DISPID_SGRsCount',
    'SpeechStreamSeekPositionType', 'DISPID_SVEViseme',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SPIRule',
    'IInternetSecurityManager', 'SPWORDTYPE', 'SPCS_DISABLED',
    'SpeechGrammarTagWildcard', 'SPAO_RETAIN_AUDIO', 'SVP_19',
    'SPEI_RECOGNITION', 'DISPID_SDKDeleteKey', 'SPSERIALIZEDPHRASE',
    'DISPID_SPIGetDisplayAttributes', 'DISPID_SBSFormat',
    'ISpResourceManager', 'SpCompressedLexicon',
    'DISPIDSPTSI_SelectionOffset', 'SpeechLexiconType',
    'SpCustomStream', 'DISPID_SLPsItem', 'eLEXTYPE_PRIVATE15',
    'DISPID_SPPValue', 'SGLexical',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'ISpeechAudioStatus', 'ISpStreamFormat', 'SDTDisplayText',
    'eLEXTYPE_PRIVATE11', 'SP_VISEME_18', 'SAFT48kHz16BitMono',
    'DISPID_SOTRemove', 'DISPID_SDKDeleteValue',
    'SVSFParseAutodetect', 'DISPID_SPEAudioSizeBytes', 'SGRSTTWord',
    'SVP_2', 'SWTDeleted', 'DISPID_SGRsDynamic', 'eLEXTYPE_PRIVATE12',
    'SPSHT_OTHER', 'SAFT24kHz8BitStereo',
    'DISPID_SLRemovePronunciation', 'SAFT8kHz8BitMono',
    'SPAUDIOSTATUS', 'DISPID_SPEsItem', 'SDKLCurrentUser',
    'DISPID_SRSClsidEngine', 'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE',
    'DISPID_SPCLangId', 'DISPID_SRGDictationLoad',
    'DISPID_SGRSTs_NewEnum', 'SVP_3', 'SVP_18',
    'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SVSInputSentencePosition', 'DISPID_SPPChildren',
    'DISPID_SVEVoiceChange', 'SPWT_DISPLAY', 'SPLO_STATIC',
    'DISPID_SVSInputWordPosition', 'DISPID_SPIGetText',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SRRTimes',
    'SpPhraseInfoBuilder', 'DISPID_SPCIdToPhone', 'SPEVENTSOURCEINFO',
    'SpVoice', 'SPSEMANTICERRORINFO', 'DISPID_SPERequiredConfidence',
    'SP_VISEME_19', 'SPGS_EXCLUSIVE', 'SpeechRecoContextState',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SAFTCCITT_uLaw_8kHzStereo',
    'SPEI_RECO_OTHER_CONTEXT', 'SVEEndInputStream',
    'DISPID_SVSLastBookmarkId', 'SPVOICESTATUS', 'DISPID_SGRsItem',
    'SVP_5', 'DISPID_SPEDisplayAttributes', 'SPINTERFERENCE_TOOQUIET',
    'SP_VISEME_12', 'DISPID_SLPSymbolic', 'DISPID_SASState',
    'DISPID_SVSRunningState', 'DISPID_SpeechLexiconWord',
    'Speech_Max_Word_Length', 'SDTAll', 'DISPID_SGRSTRule',
    'SRAONone', 'eWORDTYPE_ADDED', 'DISPID_SVSVisemeId', 'SGDisplay',
    'DISPIDSPTSI_ActiveLength', 'SREHypothesis',
    'DISPID_SASFreeBufferSpace', 'DISPID_SPRNumberOfElements',
    'ISpeechWaveFormatEx', 'SSFMCreate', 'SpStream',
    'eWORDTYPE_DELETED', 'DISPID_SVEWord', 'DISPID_SPISaveToMemory',
    'SVP_6', 'SpeechWordPronounceable', 'ISpeechCustomStream',
    'SVF_None', 'DISPID_SRAudioInputStream',
    'DISPID_SRSetPropertyString', 'DISPID_SRSNumberOfActiveRules',
    'DISPID_SLWPronunciations', 'SRTExtendableParse',
    'SPEI_SOUND_START', 'DISPID_SpeechRecognizer', 'DISPID_SRCPause',
    'SITooSlow', 'ISpeechGrammarRules',
    'ISpeechLexiconPronunciations', 'SPEI_RESERVED1',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SLWType',
    'DISPID_SRCEventInterests', 'SpFileStream',
    'DISPID_SRCEAudioLevel', 'DISPID_SGRSRule',
    'DISPID_SpeechMemoryStream', 'SVSFParseSapi',
    'SAFTGSM610_44kHzMono', 'ISpSerializeState', 'SPSHORTCUTTYPE',
    'DISPID_SPRuleNumberOfElements',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SRRGetXMLErrorInfo',
    'DISPID_SOTCDefault', 'SVPAlert', 'SAFT22kHz8BitStereo',
    'eLEXTYPE_RESERVED6', 'DISPID_SPRuleId', 'ISpeechFileStream',
    'SVP_20', 'ISpObjectWithToken', 'DISPID_SRGetFormat',
    'DISPID_SOTsItem', 'DISPID_SLPs_NewEnum',
    'SAFTCCITT_uLaw_11kHzMono', 'SRATopLevel', 'STCLocalServer',
    'eLEXTYPE_PRIVATE6', 'SpeechPropertyResponseSpeed',
    'DISPID_SpeechXMLRecoResult', 'SDTAudio',
    'DISPID_SpeechPhraseProperties', 'SVP_21', 'SLOStatic',
    'SREInterference', 'SpNotifyTranslator',
    'DISPID_SpeechFileStream', 'DISPID_SpeechLexiconWords',
    'SpeechCategoryAudioIn', 'SPRECOSTATE', 'SPAS_RUN', 'ISpPhrase',
    'SPRECOGNIZERSTATUS', 'SRAExport', 'SAFT32kHz8BitMono',
    'SSTTWildcard', 'DISPID_SPRuleEngineConfidence',
    'SAFT32kHz8BitStereo', 'SAFTCCITT_ALaw_22kHzStereo',
    'SPFM_CREATE_ALWAYS', 'DISPID_SPIRetainedSizeBytes',
    'SPEI_END_INPUT_STREAM', 'SPSLMA', 'DISPIDSPTSI',
    'DISPID_SGRAddResource', 'SPPS_Modifier', 'SECFIgnoreKanaType',
    'DISPID_SpeechObjectToken', 'DISPID_SVGetProfiles',
    'DISPID_SRCEInterference',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'DISPID_SRCRetainedAudioFormat', 'SAFTCCITT_uLaw_22kHzStereo',
    'DISPID_SRRAlternates', 'DISPID_SFSClose',
    'eLEXTYPE_USER_SHORTCUT', 'SPSHT_NotOverriden',
    'SAFTADPCM_22kHzStereo', 'DISPID_SDKEnumKeys',
    'DISPID_SADefaultFormat', 'DISPID_SPPsItem',
    'DISPID_SOTGetStorageFileName', 'DISPID_SAVolume', 'SDTRule',
    'DISPID_SWFEChannels', 'SPAR_High', 'SAFTExtendedAudioFormat',
    'DISPID_SOTDisplayUI', 'ISpeechRecoResultTimes',
    'DISPID_SpeechPhraseInfo', 'STSF_FlagCreate',
    'DISPID_SGRInitialState', 'SPSModifier', 'DISPID_SRStatus',
    'ISpEventSource', 'SSTTDictation', 'SpeechBookmarkOptions',
    'DISPID_SRSCurrentStreamNumber', 'ISpRecoGrammar2',
    'SpeechCategoryAudioOut', 'SPPS_RESERVED4', 'STCInprocHandler',
    'DISPID_SGRs_NewEnum', '_ISpeechRecoContextEvents',
    'SPEI_RESERVED6', 'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SRGRules', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SpeechLexiconPronunciation', 'ISpeechPhraseProperties',
    'SFTInput', 'DISPID_SAFGuid', 'SPINTERFERENCE_TOOSLOW',
    'Speech_Max_Pron_Length', 'DISPID_SpeechVoiceStatus', 'SRARoot',
    'DISPID_SVResume', 'SPBINARYGRAMMAR',
    'DISPID_SpeechGrammarRuleState', 'SINoSignal', 'SpeechWordType',
    'SDA_Consume_Leading_Spaces', 'DISPID_SPIAudioSizeTime',
    'DISPID_SVGetVoices', 'DISPID_SPPConfidence', 'DISPIDSPRG',
    'SP_VISEME_21', 'SREStreamStart', 'SRERecoOtherContext',
    'SPEI_SR_RETAINEDAUDIO', 'tagSPPROPERTYINFO',
    'DISPID_SLPPhoneIds', 'IStream', 'DISPID_SMSADeviceId',
    'SDA_One_Trailing_Space', 'SAFT24kHz16BitStereo',
    'DISPID_SVSLastResult', 'SpeechTokenKeyFiles',
    'SpeechDictationTopicSpelling', 'SGDSActiveUserDelimited',
    'DISPID_SPRules_NewEnum', 'ISpeechLexiconWords', 'SPEI_MIN_SR',
    'SPEI_RESERVED2', 'SP_VISEME_4',
    'SpeechGrammarRuleStateTransitionType',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SPEI_PHONEME',
    'SVPOver', 'SP_VISEME_11', 'SPEI_SR_PRIVATE', 'SpMMAudioEnum',
    'SAFTADPCM_8kHzStereo', 'SAFT8kHz16BitStereo', 'DISPID_SOTId',
    'DISPID_SVSkip', 'SAFT32kHz16BitStereo', 'DISPID_SGRSTNextState',
    'SAFT24kHz8BitMono', 'SAFTADPCM_44kHzStereo',
    'DISPID_SRAudioInput', 'SPPROPERTYINFO',
    'SpeechRetainedAudioOptions', 'DISPID_SpeechPhraseBuilder',
    'DISPID_SPPName', 'DISPID_SVGetAudioOutputs', 'SPFM_CREATE',
    'DISPID_SPILanguageId', 'DISPID_SPRDisplayAttributes',
    'SPAUDIOSTATE', 'SPPHRASEPROPERTY', 'SPPHRASE',
    'DISPID_SPRuleConfidence', 'SREPropertyStringChange',
    'SVSFParseSsml', 'DISPID_SWFEBitsPerSample',
    'SAFTCCITT_ALaw_22kHzMono', 'eLEXTYPE_RESERVED9',
    'DISPID_SpeechAudioBufferInfo', 'SPEI_SR_BOOKMARK',
    'DISPID_SLPsCount', 'SPWAVEFORMATTYPE', 'SPRECOCONTEXTSTATUS',
    'DISPID_SASNonBlockingIO', 'SSFMCreateForWrite', 'SVSFIsNotXML',
    'SPSNotOverriden', 'ISpeechPhraseAlternates',
    'DISPID_SGRSTsCount', 'DISPID_SpeechPhoneConverter',
    'SAFT16kHz16BitStereo', 'DISPIDSPTSI_SelectionLength',
    'SPINTERFERENCE_NOISE', 'SpObjectTokenCategory', 'SLTUser',
    'ISpStream', 'ISpeechRecognizerStatus', 'SPEI_WORD_BOUNDARY',
    'SpeechLoadOption', 'SPWF_SRENGINE', 'SGLexicalNoSpecialChars',
    'DISPID_SDKGetBinaryValue', 'SRCS_Enabled',
    'DISPID_SGRSAddWordTransition', 'SPRS_ACTIVE_USER_DELIMITED',
    'SPSHT_EMAIL', 'SpeechPropertyAdaptationOn', 'ISpRecognizer3',
    'DISPID_SRGIsPronounceable', 'SAFT11kHz8BitMono',
    'SAFT11kHz16BitStereo', 'SAFT44kHz8BitMono',
    'DISPID_SWFEExtraData', 'SAFTDefault', 'ISpeechPhraseAlternate',
    'SPPHRASERULE', 'ISpShortcut', 'SPPS_Function',
    'DISPID_SVSInputSentenceLength', 'SVEAudioLevel',
    'SPXRO_Alternates_SML', 'SpeechCategoryVoices',
    'DISPID_SRCCmdMaxAlternates', 'DISPID_SPRsItem',
    'DISPID_SABIBufferSize', 'DISPID_SOTDataKey',
    'SAFTCCITT_ALaw_11kHzStereo', 'SECFIgnoreCase', 'SRSEIsSpeaking',
    'SpeechCategoryPhoneConverters', 'DISPID_SPPParent',
    'DISPID_SMSSetData', 'SPEI_HYPOTHESIS', 'SPPS_RESERVED1',
    'SAFT16kHz16BitMono', 'DISPID_SBSWrite', 'eLEXTYPE_PRIVATE1',
    'DISPID_SpeechRecoContext', 'DISPID_SAStatus',
    'SPRECORESULTTIMES', 'DISPID_SRCVoice', 'SAFT48kHz16BitStereo',
    'DISPID_SPPsCount', 'DISPID_SPCPhoneToId', 'ISpNotifySink',
    'DISPID_SMSAMMHandle', 'SPWORDPRONUNCIATION', 'DISPID_SPPId',
    'DISPID_SGRId', 'DISPID_SpeechMMSysAudio', 'SpeechFormatType',
    'ISpeechXMLRecoResult', 'SVSFIsFilename', 'SPEI_RESERVED5',
    'SASStop', 'SVSFParseMask', 'DISPID_SPEEngineConfidence',
    'IInternetSecurityMgrSite', 'DISPID_SLGetGenerationChange',
    'SAFT11kHz16BitMono', 'SpeechGrammarWordType',
    'DISPID_SGRSTWeight', 'DISPID_SRRGetXMLResult',
    'DISPID_SVDisplayUI', 'DISPID_SRCVoicePurgeEvent',
    'DISPID_SVAlertBoundary', 'ISpLexicon', 'DISPID_SVStatus',
    'SAFT48kHz8BitMono', 'SPCATEGORYTYPE', 'SAFTCCITT_ALaw_44kHzMono',
    'ISpEventSink', 'SVP_12', 'SREStateChange',
    'ISpeechPhraseReplacements', 'DISPID_SOTsCount',
    'DISPID_SLGenerationId', 'DISPID_SDKGetlongValue', 'SPEVENTENUM',
    'IEnumString', 'SSTTTextBuffer', 'SpeechVoicePriority',
    'SpSharedRecoContext', 'DISPID_SWFESamplesPerSec',
    'SAFTCCITT_ALaw_8kHzMono', 'SPAR_Unknown',
    'DISPID_SpeechPhraseElements', 'SITooFast', 'eLEXTYPE_PRIVATE13',
    'DISPID_SGRSTText', 'DISPID_SPAsCount', 'SPINTERFERENCE_TOOFAST',
    'SRTAutopause', 'IEnumSpObjectTokens', 'eLEXTYPE_PRIVATE18',
    'SpeechMicTraining', 'SRERecognition', 'SpeechRecognizerState',
    'SDTLexicalForm', 'SGPronounciation', 'SDA_Two_Trailing_Spaces',
    'DISPID_SGRsAdd', 'DISPID_SRGCmdLoadFromObject',
    'SAFT48kHz8BitStereo', 'ISpPhoneConverter', 'DISPID_SPEs_NewEnum',
    'SRSInactiveWithPurge', 'SVSFNLPSpeakPunc',
    'DISPID_SpeechAudioFormat', 'SREPropertyNumChange',
    'ISpeechRecoResult2', 'SpeechInterference', 'SPVPRI_ALERT',
    'DISPID_SPRs_NewEnum', 'ISpeechObjectTokenCategory', 'SRTReSent',
    'SPSHORTCUTPAIRLIST', 'SPRST_INACTIVE_WITH_PURGE',
    'SAFT12kHz16BitMono', 'SP_VISEME_3', 'SpTextSelectionInformation',
    'SGSDisabled', 'SPXMLRESULTOPTIONS', 'ISpRecoCategory',
    'SpeechAudioFormatGUIDText', '_SPAUDIOSTATE',
    'DISPID_SRGDictationUnload', 'SPSSuppressWord', 'SSFMOpenForRead',
    'SPPS_Verb', 'DISPID_SRCRecognizer', 'SPWORDPRONOUNCEABLE',
    'SREStreamEnd', 'ISpeechPhraseElement', 'STCRemoteServer',
    'eLEXTYPE_APP', 'DISPID_SVEAudioLevel', 'SECFEmulateResult',
    'SpeechEngineProperties', 'SPLEXICONTYPE', 'ISpeechRecognizer',
    'eLEXTYPE_PRIVATE20', 'SPFM_OPEN_READWRITE', 'SREPhraseStart',
    'SVP_11', 'ISpRecoContext2', 'SpeechStreamFileMode',
    'DISPID_SRCEFalseRecognition', 'SPEI_MAX_TTS', 'SREAllEvents',
    'DISPID_SLPPartOfSpeech', 'DISPID_SRSCurrentStreamPosition',
    'SVSFPersistXML', 'ISpeechRecoGrammar', 'SBOPause',
    'ISpeechLexiconPronunciation', 'SREAdaptation', 'SpShortcut',
    'SRESoundStart', 'SPSTREAMFORMATTYPE', 'DISPID_SDKSetLongValue',
    'SPVPRIORITY', 'SPSUnknown', 'DISPID_SVESentenceBoundary',
    'DISPID_SpeechObjectTokenCategory', 'SAFTGSM610_8kHzMono',
    'DISPID_SRGetRecognizers', 'SPEI_PHRASE_START',
    'SpeechCategoryRecognizers', 'SP_VISEME_15',
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SDKSetBinaryValue',
    'SPEI_SR_AUDIO_LEVEL', 'SAFT11kHz8BitStereo',
    'DISPID_SRRSpeakAudio', 'SPAS_STOP', 'DISPID_SRSAudioStatus',
    'ISpGrammarBuilder', 'ISpVoice', 'DISPID_SLWsItem',
    'SPPS_RESERVED3', 'ISpeechDataKey', 'DISPID_SpeechAudio',
    'SVP_10', 'SAFTCCITT_uLaw_44kHzMono', 'SPEI_RESERVED3',
    'DISPID_SGRAddState', 'SGRSTTTextBuffer', 'SPXRO_SML',
    'SPEI_PROPERTY_NUM_CHANGE', 'ISpObjectTokenCategory',
    'DISPID_SWFEAvgBytesPerSec', 'DISPID_SpeechPhraseAlternate',
    'SAFTADPCM_44kHzMono', 'SPWF_INPUT', 'SPCT_DICTATION',
    'SpeechTokenKeyAttributes', 'ISpPhoneticAlphabetConverter',
    'DISPID_SRCRequestedUIType', 'SPSMF_SAPI_PROPERTIES',
    'Speech_StreamPos_RealTime', 'DISPID_SGRSTPropertyId', 'SPWORD',
    'SITooLoud', 'ISpNotifySource', 'DISPID_SRCEHypothesis',
    'SPINTERFERENCE_LATENCY_WARNING', 'SRAInterpreter',
    'SDTReplacement', 'SVP_8', 'SPCT_COMMAND',
    'DISPID_SRCEPropertyStringChange', 'UINT_PTR',
    'SpeechAddRemoveWord', 'DISPID_SPRFirstElement',
    'SpeechPartOfSpeech', 'SAFTADPCM_22kHzMono', 'DISPID_SGRSTType',
    'DISPID_SLWsCount', 'DISPID_SRCEBookmark',
    'SSSPTRelativeToCurrentPosition', 'STCAll',
    'SpUnCompressedLexicon', 'ISpPhoneticAlphabetSelection',
    'DISPID_SREmulateRecognition', 'SASPause', 'SpeechDiscardType',
    'SpPhoneConverter', 'SpeechGrammarTagDictation',
    'ISpeechRecoResult', 'DISPID_SASCurrentSeekPosition',
    'DISPID_SPIStartTime', 'ISpeechGrammarRule',
    'SAFTCCITT_uLaw_8kHzMono', 'SpInprocRecognizer',
    '__MIDL_IWinTypes_0009', 'DISPID_SPRuleParent', 'SVP_1',
    'DISPID_SABufferNotifySize', 'DISPID_SpeechPhraseProperty',
    'DISPID_SGRAttributes', 'ISpXMLRecoResult',
    'DISPID_SLGetPronunciations', 'DISPID_SOTs_NewEnum',
    'SpeechRegistryLocalMachineRoot', 'DISPID_SGRSTsItem',
    'ISpeechVoice', 'SPEI_START_SR_STREAM', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SpeechAudioStatus', 'DISPID_SVSpeakCompleteEvent',
    'SPAUDIOBUFFERINFO', 'SRADynamic', 'eLEXTYPE_USER',
    'DISPID_SpeechPhraseRule', 'WAVEFORMATEX',
    'SpeechGrammarTagUnlimitedDictation', 'DISPID_SOTCId',
    'SpeechVisemeFeature', 'SRTEmulated', 'SGDSActiveWithAutoPause',
    'SVP_15', 'DISPID_SPAsItem', 'DISPID_SRCERecognition',
    'DISPID_SpeechGrammarRules', 'ISpeechTextSelectionInformation',
    'DISPID_SRGCommit', 'DISPID_SDKOpenKey', 'SpeechVoiceSpeakFlags',
    'DISPID_SMSALineId', 'DISPID_SVEStreamEnd', 'ISpDataKey',
    'eLEXTYPE_PRIVATE19', 'SpLexicon', 'SpeechTokenValueCLSID',
    'DISPID_SPEDisplayText', 'DISPID_SOTGetDescription',
    'SPDATAKEYLOCATION', 'LONG_PTR', 'SPEVENT',
    'DISPID_SLAddPronunciation', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SRSSupportedLanguages', 'DISPID_SRCEStartStream',
    'SGRSTTDictation', 'SVSFNLPMask', 'DISPID_SRDisplayUI',
    'DISPID_SRGId', 'SpStreamFormatConverter', 'SPFM_NUM_MODES',
    'SPEI_INTERFERENCE', 'SPRS_INACTIVE', 'DISPID_SRIsUISupported',
    'ISpeechPhraseInfoBuilder', 'DISPID_SPRulesCount', 'SPRST_ACTIVE',
    'SAFTCCITT_uLaw_22kHzMono', 'SpeechRecoEvents', 'SVF_Stressed',
    'SDKLDefaultLocation', 'DISPID_SAFType', 'SDKLCurrentConfig',
    'ISpeechLexiconWord', 'DISPID_SVGetAudioInputs',
    'SAFTADPCM_11kHzStereo', 'SPSHT_Unknown', 'ISpNotifyTranslator',
    'SPCT_SLEEP', 'DISPID_SMSGetData', 'SpeechTokenKeyUI',
    'SPWORDPRONUNCIATIONLIST', 'SAFT12kHz16BitStereo', 'SP_VISEME_16',
    'SVP_9', 'ISpRecoResult', 'SpeechAudioProperties',
    'DISPID_SpeechLexicon', 'DISPID_SDKSetStringValue', 'SPPS_LMA',
    'ISpAudio', 'SpeechVisemeType', 'DISPID_SLGetWords',
    'SPAS_CLOSED', 'ISpPhraseAlt', 'eLEXTYPE_PRIVATE9',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SOTMatchesAttributes',
    'SVEPhoneme', 'SpSharedRecognizer', 'DISPID_SPIProperties',
    'ISpeechPhraseElements', 'DISPID_SRSetPropertyNumber',
    'eLEXTYPE_PRIVATE16',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SAFTNonStandardFormat', 'SAFT32kHz16BitMono', 'SPAO_NONE',
    'SGDSInactive', 'DISPID_SpeechBaseStream',
    'SPADAPTATIONRELEVANCE', 'DISPID_SRRTLength',
    'SSSPTRelativeToEnd', 'DISPID_SGRName', 'DISPID_SWFEBlockAlign',
    'SPTEXTSELECTIONINFO', 'SRAORetainAudio', 'SP_VISEME_6',
    'DISPID_SVEPhoneme', 'SpeechRecoProfileProperties',
    'SVESentenceBoundary', 'DISPID_SVEStreamStart',
    'SPRST_ACTIVE_ALWAYS', 'DISPID_SPIElements', 'DISPID_SOTCSetId',
    'DISPID_SPPFirstElement', 'SPSEMANTICFORMAT',
    'DISPID_SDKCreateKey', 'SREFalseRecognition', 'SPEI_MIN_TTS',
    'DISPID_SWFEFormatTag', 'eLEXTYPE_PRIVATE17', 'DISPID_SLWWord',
    'DISPIDSPTSI_ActiveOffset', 'SRSActiveAlways', 'SFTSREngine',
    'SAFTGSM610_22kHzMono', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SP_VISEME_13', 'SpAudioFormat', 'SPEI_PROPERTY_STRING_CHANGE',
    'ISpeechPhraseInfo', 'DISPID_SpeechGrammarRuleStateTransition',
    'SPLOADOPTIONS', 'SINoise', 'STSF_CommonAppData',
    'DISPID_SpeechObjectTokens', 'SAFT22kHz16BitMono', 'SPGS_ENABLED',
    'SPEI_ADAPTATION', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SRCAudioInInterferenceStatus', 'SVP_17',
    'DISPID_SPANumberOfElementsInResult',
    'SpeechVoiceCategoryTTSRate', 'eLEXTYPE_RESERVED10',
    'SAFTADPCM_8kHzMono', 'SPBO_TIME_UNITS',
    'DISPID_SPEAudioStreamOffset', 'SAFT12kHz8BitStereo',
    'SPCT_SUB_DICTATION', 'DISPID_SRGCmdSetRuleState', 'SPPS_Noun',
    ...
    'DISPID_SPEsCount', 'DISPID_SpeechPhraseRules', 'SPPS_Unknown',
    'SPDKL_CurrentUser', 'eLEXTYPE_PRIVATE3', 'SpeechRunState',
    'eLEXTYPE_PRIVATE2', 'DISPID_SpeechVoice', 'ISpeechObjectTokens',
    'SBONone', 'Speech_StreamPos_Asap', 'SpMMAudioIn',
    'DISPID_SABIMinNotification', 'SpeechRuleAttributes',
    'DISPID_SRGSetTextSelection', 'ISpRecognizer',
    'DISPID_SGRsFindRule', 'SPSMF_UPS', 'SAFT16kHz8BitMono',
    'SAFTCCITT_ALaw_44kHzStereo', 'ISpeechLexicon',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SPSNoun',
    'Speech_Default_Weight', 'DISPID_SABufferInfo', 'SRTSMLTimeout',
    'DISPID_SPPEngineConfidence', 'SpeechRecognitionType',
    'SGDSActive', 'DISPID_SRGetPropertyNumber',
    'DISPID_SRGetPropertyString', 'SAFT16kHz8BitStereo',
    '_ISpeechVoiceEvents', 'SVEStartInputStream',
    'DISPID_SRCERecognitionForOtherContext', 'DISPID_SVSPhonemeId',
    'tagSTATSTG', 'SINone', 'DISPID_SpeechDataKey',
    'DISPID_SRRecognizer', 'SPAS_PAUSE', 'DISPID_SRRTTickCount',
    'SPWT_PRONUNCIATION', 'SPRULE', 'DISPID_SRCERequestUI',
    'DISPID_SRGRecoContext', 'SPDKL_LocalMachine',
    'eLEXTYPE_MORPHOLOGY', 'DISPID_SRCESoundStart', 'SVSFIsXML',
    'SPPARTOFSPEECH', 'DISPID_SVRate', 'SECFNoSpecialChars',
    'DISPID_SPRsCount', 'SpeechCategoryAppLexicons',
    'SPDKL_DefaultLocation', 'DISPID_SPIReplacements', 'SP_VISEME_9',
    'DISPID_SRRRecoContext', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SRCEEndStream', 'SPSHORTCUTPAIR',
    'SpeechPropertyResourceUsage', 'SP_VISEME_0',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'ISequentialStream',
    'DISPID_SPPs_NewEnum', 'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SVP_13',
    'DISPID_SOTGetAttribute', 'SPFM_OPEN_READONLY',
    'eLEXTYPE_PRIVATE7', 'SpNullPhoneConverter',
    'DISPID_SpeechPhraseReplacements', 'DISPID_SRRAudioFormat',
    'SPVISEMES', 'ISpeechVoiceStatus', 'SVSFUnusedFlags',
    'SPRST_NUM_STATES', 'DISPID_SRGDictationSetState',
    'DISPID_SGRSAddSpecialTransition', 'SPAR_Low', 'DISPID_SRProfile',
    'SP_VISEME_17', 'SpeechAudioFormatType', 'ISpeechObjectToken',
    'ISpeechAudioFormat', 'SSFMOpenReadWrite',
    'DISPID_SRCEPhraseStart', 'DISPID_SOTCEnumerateTokens',
    'SpInProcRecoContext', 'SPVPRI_OVER', 'SpWaveFormatEx',
    'DISPID_SLWLangId', 'SPGRAMMARSTATE',
    'DISPID_SRGSetWordSequenceData', 'SVP_4', 'SAFTText', 'SVP_14',
    'DISPID_SpeechRecoResultTimes',
    'SpeechPropertyLowConfidenceThreshold', 'SWTAdded',
    'SPEI_TTS_AUDIO_LEVEL', 'DISPID_SRCEPropertyNumberChange',
    'SAFT44kHz16BitStereo', 'DISPID_SVSpeakStream',
    'SpeechPropertyHighConfidenceThreshold', 'SVP_7',
    'SPPS_Noncontent', 'ISpeechPhraseRule',
    'DISPID_SRGCmdLoadFromFile', 'DISPID_SRCState', 'DISPID_SGRClear',
    'SITooQuiet', 'SRADefaultToActive', 'SVF_Emphasis',
    'eLEXTYPE_PRIVATE5', 'DISPID_SVPause', 'DISPID_SRRAudio',
    'DISPID_SVEBookmark', 'SECFDefault', 'DISPID_SVIsUISupported',
    'SPINTERFERENCE_NONE', 'SpeechVoiceSkipTypeSentence',
    'SpeechGrammarState', 'ISpProperties', 'SECHighConfidence',
    'SPFILEMODE', 'ISpeechGrammarRuleStateTransitions',
    'ISpStreamFormatConverter', 'ISpeechBaseStream',
    'DISPID_SpeechLexiconProns', 'SPCS_ENABLED',
    'SpeechEngineConfidence', 'DISPID_SDKEnumValues',
    'DISPID_SPRuleChildren', 'DISPID_SpeechPhraseAlternates',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SPRULESTATE',
    'SDA_No_Trailing_Space', 'DISPID_SGRSTransitions',
    'ISpObjectToken', 'SpeechUserTraining', 'SGRSTTEpsilon',
    'DISPID_SASCurrentDevicePosition', 'SECLowConfidence',
    'STSF_LocalAppData', 'SpeechTokenIdUserLexicon',
    'DISPID_SPPNumberOfElements', 'DISPID_SVPriority',
    'DISPID_SVSInputWordLength', 'DISPID_SOTCreateInstance',
    'SpeechDisplayAttributes', 'DISPID_SpeechVoiceEvent', 'SASClosed',
    'SpeechAllElements', 'SAFT44kHz16BitMono', '_RemotableHandle',
    'SPPS_NotOverriden', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SPERetainedSizeBytes', 'SPEI_VOICE_CHANGE', 'SVP_16',
    'ISpeechRecoContext', 'SDTProperty', 'ISpRecoGrammar', 'SVP_0',
    'DISPID_SRCESoundEnd', 'SPEI_SOUND_END',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'DISPID_SVEventInterests', 'STCInprocServer',
    'SAFTCCITT_ALaw_11kHzMono', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'SGRSTTRule', 'SRSInactive', 'SREAudioLevel', 'DISPID_SBSRead',
    'SREPrivate', 'SPEI_REQUEST_UI', 'SGSEnabled',
    'SPBOOKMARKOPTIONS', 'ISpeechPhraseReplacement', 'SP_VISEME_5',
    'SPPS_SuppressWord', 'DISPID_SRState', 'SpeechTokenShellFolder',
    'DISPID_SRCResume', 'DISPID_SPEAudioTimeOffset',
    'SAFT8kHz16BitMono', 'SECNormalConfidence', 'ISpeechMemoryStream',
    'SPEI_RECO_STATE_CHANGE', 'SPVPRI_NORMAL', 'SLODynamic',
    'DISPID_SPAPhraseInfo', 'SRAImport', 'DISPID_SPEAudioSizeTime',
    'DISPID_SPRuleName', 'SpeechAudioVolume',
    'SpeechAudioFormatGUIDWave', 'DISPID_SPIGrammarId',
    'SpMemoryStream', 'SPEI_START_INPUT_STREAM',
    'SAFTADPCM_11kHzMono', 'eLEXTYPE_PRIVATE8', 'ISpeechPhraseRules',
    'SDTAlternates', 'DISPID_SRRSetTextFeedback', 'SPPS_RESERVED2',
    'DISPID_SpeechRecognizerStatus', 'ISpeechPhoneConverter',
    'SAFTTrueSpeech_8kHz1BitMono', 'SpResourceManager', 'SP_VISEME_1',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SPEI_UNDEFINED',
    'SPEI_VISEME', 'SPSInterjection', 'eLEXTYPE_PRIVATE4',
    'DISPID_SOTIsUISupported', 'SPINTERFERENCE', 'SPPS_Interjection',
    'SRESoundEnd', 'SGSExclusive', 'SPSFunction',
    'DISPID_SVSLastBookmark', 'SP_VISEME_8', 'DISPID_SLPType',
    'SP_VISEME_14', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SpeechRecoResult', 'DISPID_SVAudioOutputStream',
    'SpMMAudioOut', 'SPWORDLIST', 'DISPID_SGRSTPropertyName',
    'SPCONTEXTSTATE', 'SAFT8kHz8BitStereo', 'eLEXTYPE_PRIVATE14',
    'SpeechRuleState', 'DISPID_SLPLangId',
    'DISPID_SGRSTPropertyValue', 'DISPID_SPEActualConfidence',
    'ISpeechAudio', 'SPDKL_CurrentConfig', 'SVSFDefault',
    'DISPID_SVEEnginePrivate', 'DISPID_SRGCmdLoadFromMemory',
    'SRCS_Disabled', 'SWPUnknownWordUnpronounceable',
    'ISpeechGrammarRuleState',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SVWaitUntilDone', 'eLEXTYPE_RESERVED8',
    'SpeechSpecialTransitionType', 'SPINTERFERENCE_TOOLOUD',
    'SPEI_TTS_PRIVATE', 'SpeechTokenContext', 'DISPID_SVSpeak',
    'DISPID_SPIEngineId', 'SVSFVoiceMask', 'SpeechAudioState',
    'ISpRecognizer2', 'eLEXTYPE_RESERVED7',
    'SAFTCCITT_uLaw_44kHzStereo', 'SPAR_Medium', 'DISPID_SRGReset',
    'DISPID_SPRuleFirstElement', 'DISPID_SRCEAdaptation',
    'SP_VISEME_2', 'DISPID_SASetState', 'SpeechDataKeyLocation',
    'SPEI_FALSE_RECOGNITION', 'DISPID_SpeechPhraseReplacement',
    'DISPID_SPAs_NewEnum', 'DISPID_SGRsCommitAndSave',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SOTCGetDataKey',
    'SWPUnknownWordPronounceable', 'DISPID_SRCSetAdaptationData',
    'DISPID_SpeechRecoResult2', 'SAFT24kHz16BitMono',
    'SPPHRASEREPLACEMENT', 'DISPID_SCSBaseStream',
    'DISPID_SABIEventBias', 'SpeechRegistryUserRoot',
    'DISPID_SGRsCommit', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SRCCreateGrammar', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SPIEnginePrivateData', 'tagSPTEXTSELECTIONINFO',
    'SP_VISEME_10', 'SpObjectToken', 'SECFIgnoreWidth', 'SPBO_PAUSE',
    'DISPID_SRCreateRecoContext',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SREBookmark',
    'SVEWordBoundary', 'SPPHRASEELEMENT', 'DISPID_SOTSetId',
    'SAFTNoAssignedFormat', 'DISPID_SFSOpen',
    'SAFTCCITT_ALaw_8kHzStereo', 'SAFT22kHz8BitMono', 'SRSActive',
    'SRTStandard', 'SWPKnownWordPronounceable', 'SRSEDone',
    'SAFT22kHz16BitStereo', 'DISPID_SVAudioOutput', 'DISPID_SPRText',
    'DISPID_SVVolume', 'SPCT_SUB_COMMAND', 'SPEI_SENTENCE_BOUNDARY',
    'SAFT12kHz8BitMono', 'ISpMMSysAudio', 'SAFT44kHz8BitStereo',
    'SPRST_INACTIVE', 'DISPID_SRGCmdSetRuleIdState', 'SP_VISEME_20',
    'DISPID_SpeechGrammarRule', 'SASRun', 'SPGRAMMARWORDTYPE',
    'SPLO_DYNAMIC', 'DISPID_SpeechCustomStream', 'DISPID_SVVoice',
    'DISPID_SOTCategory', 'SRERequestUI', 'SVSFPurgeBeforeSpeak',
    'DISPID_SLAddPronunciationByPhoneIds', 'SDTPronunciation',
    'SLTApp', 'DISPID_SpeechPhraseElement', 'SVSFlagsAsync',
    'SGRSTTWildcard', 'DISPID_SRRTStreamTime', 'SVEViseme',
    'SVEAllEvents', 'SPSVerb', 'ISpeechGrammarRuleStateTransition',
    'DISPID_SAFGetWaveFormatEx', 'ISpeechAudioBufferInfo',
    'DISPID_SRCRetainedAudio', 'SPEI_END_SR_STREAM',
    'eLEXTYPE_RESERVED4', 'SPWT_LEXICAL', 'DISPID_SRRPhraseInfo',
    'DISPID_SRIsShared', 'SVEBookmark', 'SVPNormal', 'DISPID_SBSSeek',
    'SSSPTRelativeToStart', 'DISPID_SRCEEnginePrivate',
    'SpPhoneticAlphabetConverter', 'DISPID_SPIAudioStreamPosition',
    'SP_VISEME_7', 'eLEXTYPE_PRIVATE10', 'DISPID_SPRulesItem',
    'DISPID_SRRTOffsetFromStart', 'SVEVoiceChange',
    'ISpeechMMSysAudio', 'ISpeechPhraseProperty',
    'DISPID_SRRSaveToMemory', 'ISpeechRecoResultDispatch',
    'SPBO_AHEAD', 'DISPID_SPARecoResult', 'SPINTERFERENCE_NOSIGNAL',
    'SPAUDIOOPTIONS', 'DISPID_SPPBRestorePhraseFromMemory',
    'SDKLLocalMachine', 'SPRS_ACTIVE', 'SPEI_TTS_BOOKMARK',
    'SPEI_MAX_SR', 'SAFTGSM610_11kHzMono', 'ISpeechResourceLoader',
    'DISPID_SPIAudioSizeBytes', 'SPBO_NONE', 'DISPID_SPACommit',
    'DISPID_SPEPronunciation', 'ISpRecoContext', 'SVEPrivate',
    'SpeechCategoryRecoProfiles', 'SpeechVoiceEvents',
    'DISPID_SAEventHandle', 'DISPID_SPELexicalForm',
    'DISPID_SVSLastStreamNumberQueued', 'STSF_AppData',
    'SPSERIALIZEDRESULT', 'DISPID_SOTRemoveStorageFileName'
]
